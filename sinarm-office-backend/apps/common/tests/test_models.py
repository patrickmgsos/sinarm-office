"""Tests for reusable model mixins."""
...
def test_archivable_model_is_abstract() -> None:
    """ArchivableModel must be opt-in for entities that need archive semantics."""
    assert ArchivableModel._meta.abstract is True
